...
use crate::config::{MAX_APP_NUM, MAX_ID};
...
lazy_static! {
    ...
    pub static ref COUNTS: UPSafeCell<[[usize; MAX_ID]; MAX_APP_NUM]> = unsafe {
        UPSafeCell::new([[0; MAX_ID]; MAX_APP_NUM])
    };
}
